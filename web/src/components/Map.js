...
class Map extends Component {
    ...
    async componentDidMount() {
        ...
        const scoresPromise = get_scores().then((res) => {
            console.log("hit then() of score promise")
            const inference = JSON.parse(res.Payload)
            ...
            this.setState({ data: {'id': idList, 'val': valList, 'name': nameList}});
        })
